...
class MemoryPool
{
    ...
    public function get(int $id): ?mixed
    {
        ...
        $obj = $this->pool[$id];
        if ($obj->status === "free") {
            echo "[INFO] Object ID {$id} is free, no data available\n";
            return null;
        }
    ...
    public function set(int $id, mixed $data): void
    {
        if (!isset($this->pool[$id])) {
        ...
        $obj = $this->pool[$id];
        if ($obj->status === "free") {
            echo "[ERROR] Cannot set data on free object ID {$id}\n";
            return;
        }
    ...
    public function forceUnlockAll(): void
    {
        ...
        echo "[WARNING] Force unlocked all objects (unsafe)\n";
    }
